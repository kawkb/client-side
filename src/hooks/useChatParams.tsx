...
const useChatParams = create<ChatParamsStore>()((set) => ({
  ...
  setChannelMessages: (messages: Array<ChannelMsg>) =>
    set((state) => ({
      activeChannel: { ...state.activeChannel, messages: messages } as Channel,
    })),
  setDMsMessages: (messages: Array<DMsMsg>) =>
    set((state) => ({
      activeDMs: { ...state.activeDMs, messages: messages } as DMs,
    })),
